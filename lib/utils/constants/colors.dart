...
class MyAppColors {
  ...
  // Basic Colors
  static const Color primary = Color(0xFF19520b);
  static const Color secondary = Color(0xFF8ac43e);
  static const Color accent = Color(0xFFECC600);
  ...
  static Color darkContainer = MyAppColors.white.withOpacity(.1);
